      ...
      <div className="dark-card p-4 p-lg-5 mb-4 position-relative overflow-hidden shadow-lg" style={{ background: 'linear-gradient(135deg, rgba(18, 28, 54, 0.95) 0%, rgba(9, 14, 28, 0.95) 100%)' }}>
        ...
        <div className="row align-items-center position-relative" style={{ zIndex: 2 }}>
          <div className="col-12 col-lg-8">
            ...
            <div className="row g-3 mb-3" style={{ maxWidth: '620px' }}>
              {[
                { label: 'Active team', value: String(project.members?.length || 5), icon: 'bi-people-fill', tone: 'cyan' },
                { label: 'Agent pods', value: '4', icon: 'bi-cpu-fill', tone: 'purple' },
                { label: 'Sprint health', value: '92%', icon: 'bi-activity', tone: 'emerald' }
              ].map((stat) => (
