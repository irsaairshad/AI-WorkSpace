          ...
          {showUserMenu && (
            ...
            >
              ...
              <div className="p-2 mb-3 rounded-3 bg-dark border border-secondary border-opacity-30">
                <div className="text-white fw-bold small">{currentUser?.full_name || 'Irsa Irshad'}</div>
                <div className="text-secondary small" style={{ fontSize: '0.74rem' }}>{currentUser?.email || 'irsa@workspace.dev'}</div>
                <div className="d-flex align-items-center justify-content-between mt-2 pt-1 border-top border-secondary border-opacity-20">
                  ...
                  <code className="text-cyan fw-bold" style={{ fontSize: '0.72rem' }}>
                    {currentUser?.public_member_id || 'USR-FE-IRSA01'}
                  </code>
                </div>
              </div>
                ...
                <button
                  ...
                  onClick={() => {
                    onSwitchActiveUser && onSwitchActiveUser({
                      full_name: 'Irsa Irshad',
                      email: 'irsa@workspace.dev',
                      role: 'Frontend Developer',
                      member_id: 'USR-FE-IRSA01'
                    });
                    setShowUserMenu(false);
                  }}
                >
                  <div>
                    <span className="d-block text-white fw-semibold" style={{ fontSize: '0.78rem' }}>Irsa Irshad</span>
                    <small className="text-secondary" style={{ fontSize: '0.68rem' }}>Frontend Developer</small>
                  </div>
                  <code className="text-cyan" style={{ fontSize: '0.68rem' }}>USR-FE-IRSA01</code>
                </button>
